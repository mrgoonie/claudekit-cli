...
export const translations = {
	en: {
		...
		healthAllPassed: "All checks passed",
		healthAllPassedDesc: "Your system is healthy and all checks are passing.",
		healthErrorTitle: "Health check failed",
		healthErrorDesc: "Could not run health checks. Check your connection and try again.",
		healthRetry: "Retry",
		healthDetails: "Details",
		healthChecks: "checks",
		healthFixSuccess: "Fixed",
		healthShowAll: "Show All",
		...
		kitTotalComponents: "Components",
		kitSearchPlaceholder: "Search components...",
		kitNoSearchResults: "No matching components found",
		kitCloseDetail: "Close detail panel",
		kitCopyToClipboard: "Copy to clipboard",
		kitAttributes: "Attributes",
		kitLatestRelease: "Latest",
		...
		settingsActiveModelBadge: "Model",
		settingsModelLabel: "Active Model",
		settingsModelDescOpus: "Most capable — complex reasoning, coding, analysis",
		settingsModelDescSonnet: "Balanced — fast and intelligent for daily tasks",
		settingsModelDescHaiku: "Fastest — quick responses, lightweight tasks",
		settingsSaveModel: "Save",
		settingsModelSaved: "Saved",
		settingsHooksTitle: "Registered Hooks",
		settingsHooksEnabled: "enabled",
		settingsHooksDisabled: "disabled",
		settingsNoHooks: "No hooks registered",
		settingsMcpTitle: "MCP Servers",
		settingsMcpConfigured: "configured",
		settingsNoMcp: "No MCP servers configured",
		settingsRawJson: "Raw settings.json",
		settingsJsonCopy: "Copy",
		settingsJsonCopied: "Copied",
		settingsJsonCollapse: "Collapse",
		settingsJsonExpand: "Expand",

		// InsightsPage
		insightsTitle: "Insights",
		insightsSubtitle: "Usage analytics and activity trends",
		insightsRefresh: "Refresh",
		insightsEmptyState: "No usage data yet. Start a session to see your insights.",
	...
	vi: {
		...
		healthAllPassed: "Tất cả kiểm tra đạt",
		healthAllPassedDesc: "Hệ thống khỏe mạnh và tất cả kiểm tra đều đạt.",
		healthErrorTitle: "Kiểm tra sức khỏe thất bại",
		healthErrorDesc: "Không thể chạy kiểm tra. Kiểm tra kết nối và thử lại.",
		healthRetry: "Thử lại",
		healthDetails: "Chi tiết",
		healthChecks: "kiểm tra",
		healthFixSuccess: "Đã sửa",
		healthShowAll: "Hiện tất cả",
		...
		kitTotalComponents: "Thành phần",
		kitSearchPlaceholder: "Tìm kiếm thành phần...",
		kitNoSearchResults: "Không tìm thấy thành phần phù hợp",
		kitCloseDetail: "Đóng bảng chi tiết",
		kitCopyToClipboard: "Sao chép vào bộ nhớ tạm",
		kitAttributes: "Thuộc tính",
		kitLatestRelease: "Mới nhất",
		...
		settingsActiveModelBadge: "Mô hình",
		settingsModelLabel: "Mô hình hoạt động",
		settingsModelDescOpus: "Mạnh nhất — suy luận phức tạp, lập trình, phân tích",
		settingsModelDescSonnet: "Cân bằng — nhanh và thông minh cho tác vụ hàng ngày",
		settingsModelDescHaiku: "Nhanh nhất — phản hồi nhanh, tác vụ nhẹ",
		settingsSaveModel: "Lưu",
		settingsModelSaved: "Đã lưu",
		settingsHooksTitle: "Hooks đã đăng ký",
		settingsHooksEnabled: "bật",
		settingsHooksDisabled: "tắt",
		settingsNoHooks: "Chưa có hooks nào",
		settingsMcpTitle: "MCP Servers",
		settingsMcpConfigured: "đã cấu hình",
		settingsNoMcp: "Chưa có MCP server nào",
		settingsRawJson: "settings.json gốc",
		settingsJsonCopy: "Sao chép",
		settingsJsonCopied: "Đã sao chép",
		settingsJsonCollapse: "Thu gọn",
		settingsJsonExpand: "Mở rộng",

		// InsightsPage
		insightsTitle: "Thống kê",
		insightsSubtitle: "Phân tích sử dụng và xu hướng hoạt động",
		insightsRefresh: "Làm mới",
		insightsEmptyState: "Chưa có dữ liệu sử dụng. Bắt đầu phiên để xem thống kê.",
