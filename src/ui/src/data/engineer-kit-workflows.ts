...
export const ENGINEER_KIT_WORKFLOWS: Workflow[] = [
  ...
  // Design & Frontend
  {
    ...
    steps: [
      { id: 's1', skill: 'ui-ux-pro-max', command: '/ck:ui-ux-pro-max', transitionLabel: 'design audit' },
      { id: 's2', skill: 'frontend-development', command: '/ck:frontend-development', transitionLabel: 'build' },
    ],
    isBuiltIn: true,
  },
  {
  ...
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'excalidraw', command: '/excalidraw', transitionLabel: 'draw' },
    ],
    isBuiltIn: true,
  },
  ...
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'security-scan', command: '/ck:security-scan', transitionLabel: 'vulnerabilities' },
  ...
  // Planning & Review
  {
    ...
    steps: [
      { id: 's1', skill: 'code-review', command: '/ck:code-review' },
    ],
    isBuiltIn: true,
  },
  {
  ...
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'predict', command: '/ck:predict @plan.md' },
    ],
    isBuiltIn: true,
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'loop', command: '/ck:loop --iterations 5' },
    ],
    isBuiltIn: true,
  },
  {
  ...
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'llms', command: '/ck:llms' },
    ],
    isBuiltIn: true,
  },
  ...
  // Media & Creative
  {
    ...
    steps: [
      ...
      { id: 's2', skill: 'media-processing', command: '/ck:media-processing', transitionLabel: 'render' },
    ],
    isBuiltIn: true,
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'show-off', command: '/ck:show-off' },
    ],
    isBuiltIn: true,
  },
  ...
  // Advanced
  {
    ...
    steps: [
      { id: 's1', skill: 'team', command: '/ck:team', transitionLabel: 'delegate' },
    ],
    isBuiltIn: true,
  },
  {
    ...
    steps: [
      { id: 's1', skill: 'worktree', command: '/ck:worktree' },
    ],
    isBuiltIn: true,
  }
];
