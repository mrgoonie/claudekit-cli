        ...
        <div className="flex flex-col p-6 w-full xl:w-2/5 shrink-0 bg-white dark:bg-[#14151a]">
          <div className="flex justify-between items-start mb-4">
            <div className="flex gap-2 items-center">
              ...
              <span className="text-xs font-mono text-gray-500 dark:text-dash-text-muted">{workflow.timeEstimate}</span>
            </div>
            <button 
          ...
          <div className="flex-grow">
            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 border-b border-gray-100 dark:border-gray-800 pb-2">Implementation Recipe</h4>
                ...
                <div key={step.id} className="relative">
                  ...
                  <div className="ml-4">
                    ...
                    {step.transitionLabel && (
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">{step.transitionLabel}</p>
                    )}
                  </div>
                </div>
              ))}
