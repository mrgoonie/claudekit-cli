...
export const CkHooksConfigSchema = z
	.object({
		...
		"session-state": z.boolean().optional(),
		"cook-after-plan-reminder": z.boolean().optional(),
		"descriptive-name": z.boolean().optional(),
		"dev-rules-reminder": z.boolean().optional(),
		"plan-format-kanban": z.boolean().optional(),
		"usage-quota-cache-refresh": z.boolean().optional(),
